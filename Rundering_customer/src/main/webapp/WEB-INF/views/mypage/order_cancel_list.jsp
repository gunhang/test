...
<c:set var="cancelList" value="${dataMap.cancelList }" />
				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item active">취소내역</li>
				...
				<table class="table m-0">
					<tbody>
						<tr>
							...
							<th style="text-align:center;"><span style="font-weight:bold;">취소일자</span></th>
						</tr>
						...
						<c:if test="${!empty cancelList }">
						<c:forEach items="${cancelList }" var="list" varStatus="status">
						<tr>
