...
제2조(정의)
① "사이트" 이란 Rundering가 일정 서비스를 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 서비스를 이용할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이트를 운영하는 사업자의 의미로도 사용합니다.
...
② 이 약관은 준거법으로 한국법을 적용합니다.
   </textarea> <br> <input type="checkbox" name="req1"> 개인정보 수집 및 이용에
						동의합니다.
					</td>
				</tr>
				<tr>
...
Rundering는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
...
▶ 서비스 이용기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 이용정지 기록 Rundering는 다음과 같은 방법으로 개인정보를 수집합니다.
▶ 홈페이지, 서면양식, 전화 팩스를 통한 회원가입, 상담 게시판, 경품 행사 응모, 배송 요청
▶ 제휴사로부터의 제공
▶ 생성정보 수집 툴을 통한 수집

나. 개인정보 수집 및 이용목적
Rundering는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
...
- 보존 이유 : 통신비밀보호법
- 보존 기간 : 1년
   </textarea> <br> <input type="checkbox" name="req2"> 개인정보 수집 및 이용에
						동의합니다.
					</td>
				</tr>
				<tr>
