...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <p class="login-box-msg"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">계정을 잊으셨나요?<br> </font><font style="vertical-align: inherit;">▼▼아래 정보를 입력해주세요▼▼</font></font></p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="button" class="btn btn-primary btn-block" onclick="idGetEmail()" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">아이디 확인</font></font></button>
                        </div>
    ...
    function idGetEmail(){
    	...
    	$.ajax({
			  url:'<%=request.getContextPath()%>/login/idgetemail',
			  type:"post",
			  data: {
				  email:getEmail,
				  name:getName
