...
public class EmployeesListPageMaker {
	...
	EmployeesListCriteria cri = new EmployeesListCriteria(); 
	...
	public EmployeesListCriteria getCri() {
		return cri;
	}

	public void setCri(EmployeesListCriteria cri) {
		this.cri = cri;
	}
}
