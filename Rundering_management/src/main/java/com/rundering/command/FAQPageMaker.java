...
public class FAQPageMaker {
	...
	FAQCriteria cri = new FAQCriteria(); 
	...
	private void calcData() {
		...
		realEndPage = (int) (Math.ceil(totalCount / (double) cri.getPerPageNumQuestion()));
	...
	public FAQCriteria getCri() {
		return cri;
	}

	public void setCri(FAQCriteria cri) {
		this.cri = cri;
	}
