...
public class AcoPageMaker {
	...
	AcoCriteria cri = new AcoCriteria(); 
	...
	private void calcData() {
		...
		realEndPage = (int) (Math.ceil(totalCount / (double) cri.getPerPageNumFAQ()));
	...
	public AcoCriteria getCri() {
		return cri;
	}

	public void setCri(AcoCriteria cri) {
		this.cri = cri;
	}
