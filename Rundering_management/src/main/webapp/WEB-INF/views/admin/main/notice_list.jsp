			...
			<div class="card m-0" id="removeNotice" style="height: 398px;">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-sm btn-outline-primary" onclick="goPage('<%=request.getContextPath() %>/admin/notice/list','A050100')" style="font-weight: 500;font-size: 0.97rem;">바로가기</button>
						...
						<tbody>
							{{#each noticeList}}
								<tr style='cursor: pointer;'
									...
									<td style="max-width:100px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">{{title}}	
										{{#if noticeDate}}
