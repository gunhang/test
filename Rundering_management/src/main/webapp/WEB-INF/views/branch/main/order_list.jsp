			...
			<div class="card m-0" id="removeOrder" style="height: 398px;">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-sm btn-outline-primary" onclick="goPage('<%=request.getContextPath() %>/branch/item/list','B020100')" style="font-weight: 500;font-size: 0.97rem;">바로가기</button>
					</div>
				</div>
				...
				<div class="card-body p-0" style="height:355px; overflow:auto">
					<table class="table table-hover text-nowrap listScroll">
						<thead>
							<tr>
								<th class="width30" style="text-align:center">발주번호</th>
